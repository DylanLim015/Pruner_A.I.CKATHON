...
var formData=new FormData();formData.append("filename",blobFile);document.getElementById("loader").style.display="block";





$.ajax({url:"https://lpr.recoqnitics.com/demo-api",type:"POST",data:formData,processData:!1,contentType:!1,success:function(response){document.getElementById("loader").style.display="none";document.getElementById('response').innerHTML="";responseJSON=response
